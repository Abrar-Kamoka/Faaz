...
namespace Faaz.Services.Consultant.Infrastructure.Migrations
{
    ...
    [Migration("20260530100732_ExpandApplicationAndAddDocuments")]
    partial class ExpandApplicationAndAddDocuments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Faaz.Services.Consultant.Domain.Entities.ConsultantBlockedDate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ConsultantProfileId", "Date")
                        .HasDatabaseName("IX_ConsultantBlockedDates_ConsultantProfileId_Date");

                    b.ToTable("ConsultantBlockedDates", (string)null);
                });
