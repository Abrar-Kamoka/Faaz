...
internal sealed class PreApproveApplicationCommandValidator : AbstractValidator<PreApproveApplicationCommand>
{
    public PreApproveApplicationCommandValidator()
    {
