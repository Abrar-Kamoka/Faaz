        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentTimezone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    SessionBrief = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    DisputeResolutionNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LiveKitRoomSid = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ...
                    CreateRoomJobId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NoShowJobId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ForceCloseJobId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SessionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LiveKitRoomSid = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LiveKitEventId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    EventType = table.Column<int>(type: "int", nullable: false),
                    ParticipantIdentity = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastJoinWindowStartUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    PendingReconnectionJobId = table.Column<string>(type: "nvarchar(max)", nullable: true),
